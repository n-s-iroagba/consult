...
import Admin from '../models/Admin'; // Assuming User model and UserRole enum
...
export interface AuthenticatedRequest extends Request {
  user?: Admin // Changed from required to optional
}
...
export const assertUser = (
  req: AuthenticatedRequest
): asserts req is AuthenticatedRequest & { user: Admin } => {
  if (!req.user) {
