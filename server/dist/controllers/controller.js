...
exports.deleteAttendant = exports.updateAttendant = exports.getAttendantById = exports.getAllAttendants = exports.deleteBankDetails = exports.updateBankDetails = exports.createBankDetails = exports.getBankDetails = exports.deleteCryptoWallet = exports.updateCryptoWallet = exports.createCryptoWallet = exports.getCryptoWallets = exports.deleteEvent = exports.updateEvent = exports.getEventById = exports.getEvents = exports.createEvent = exports.sendPaymentInstructions = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const nodemailer_1 = __importDefault(require("nodemailer"));
const sequelize_1 = require("sequelize");
const Attendant_1 = __importDefault(require("../models/Attendant"));
...
const sendPaymentInstructions = async (req, res) => {
    try {
        const { email, paymentMethod, cryptoCurrency, eventId, firstName, lastName, country } = req.body;
        ...
        await Attendant_1.default.create({
            email,
            firstName,
            lastName,
            country
        ...
        if (paymentMethod === 'crypto') {
            ...
            const bank = await Bank_1.default.findOne();
            if (!bank) {
                return res.status(404).json({
                    success: false,
...
function generateCryptoEmail(firstName, event, wallet) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      ...
      <div class="content">
        ...
        <div class="highlight">
          ...
          <p><strong>Cryptocurrency:</strong> ${wallet.name}</p>
          <p><strong>Wallet Address:</strong> <code>${wallet.address.toLocaleUpperCase()}</code></p>
        </div>
        ...
        <p>Best regards,<br>The  Klitz Cyber Security Team</p>
      </div>
      <div class="footer">
...
function generateBankEmail(firstName, event, bank) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
const getEventById = async (req, res) => {
    ...
    try {
        const event = await Event_1.default.findByPk(req.params.id);
        if (!event) {
...
// --- Crypto Wallets ---
const getCryptoWallets = async (_req, res) => {
    console.log('getCryptoWallets called');
    try {
        const wallets = await CryptoWallet_1.default.findAll();
...
exports.getCryptoWallets = getCryptoWallets;
const createCryptoWallet = async (req, res) => {
    console.log('createCryptoWallet called with body:', req.body);
    try {
        const wallet = await CryptoWallet_1.default.create(req.body);
...
const updateCryptoWallet = async (req, res) => {
    ...
    try {
        const wallet = await CryptoWallet_1.default.findByPk(req.params.id);
        if (!wallet) {
...
exports.updateCryptoWallet = updateCryptoWallet;
...
exports.deleteCryptoWallet = deleteCryptoWallet;
// --- Bank Details ---
const getBankDetails = async (_req, res) => {
...
const createBankDetails = async (req, res) => {
    ...
    try {
        const bank = await Bank_1.default.create(req.body);
...
const updateBankDetails = async (req, res) => {
    ...
    try {
        const bank = await Bank_1.default.findByPk(req.params.id);
        if (!bank) {
...
const getAllAttendants = async (req, res) => {
    try {
        const attendants = await Attendant_1.default.findAll();
...
const getAttendantById = async (req, res) => {
    try {
        const { id } = req.params;
        const attendant = await Attendant_1.default.findByPk(id);
        if (!attendant) {
            res.status(404).json({
                success: false,
...
exports.getAttendantById = getAttendantById;
...
const updateAttendant = async (req, res) => {
    try {
        ...
        const existingAttendant = await Attendant_1.default.findOne({
            where: {
                email,
                id: { [sequelize_1.Op.ne]: id } // Exclude current attendant from check
            }
        });
...
exports.updateAttendant = updateAttendant;
...
exports.deleteAttendant = deleteAttendant;
