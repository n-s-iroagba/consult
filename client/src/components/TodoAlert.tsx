    ...
    >
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex-wrap p-2 bg-slate-100 rounded-full">
          <CheckCircle className="w-6 h-6 text-slate-900 mx-auto" />
        </div>
        ...
        <a
          href={link}
          data-testid={testId}
          className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-900 rounded-md hover:bg-slate-200 transition-colors self-center"
        >
